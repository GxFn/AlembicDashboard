...
import { Activity, Plus, Settings, FileText, Bookmark, FolderOpen, Clock, Library, Shield, Layers, BookOpen, HelpCircle, BrainCircuit } from 'lucide-react';
